...
export default function Home() {
  ...
  const fetchEvents = async (currentOffset: number, isReset: boolean = false) => {
    setLoading(true)
    try {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#edf6f9] via-white to-[#83c5be]/10">
      ...
      <main className="fixed top-28 left-0 right-0 bottom-0 overflow-hidden">
        <div className="container mx-auto px-4 py-8 h-full flex gap-6">
          {/* Events List - Left Side - Scrollable */}
          <div className="flex-1 min-w-0 overflow-y-auto pb-8 pr-4 scrollbar-thin scrollbar-thumb-[#83c5be] scrollbar-track-gray-100">
            {/* Show Map Button (Mobile/Tablet) */}
            <div className="xl:hidden mb-6">
              <motion.button
                onClick={() => setIsMapExpanded(true)}
                className="w-full px-6 py-3 bg-gradient-to-r from-[#006d77] to-[#83c5be] text-white rounded-full font-semibold flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-shadow"
            ...
            <AnimatePresence mode="wait">
              {loading ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Nessun evento trovato</h3>
              ...
              <div ref={observerTarget} className="flex justify-center py-12">
                {loading && (
                  <div className="flex items-center gap-2 text-[#006d77]">
                    ...
                    <span className="text-sm font-medium">Caricamento altri eventi...</span>
                  </div>
                )}
                {!hasMore && (
                  <div className="text-center">
          ...
          <div className="hidden xl:block w-[45%] max-w-2xl flex-shrink-0">
            <div className="h-full rounded-2xl overflow-hidden shadow-2xl border-2 border-[#83c5be]/30 relative group">
              <EventsMap events={events} mapId="map-sidebar" userLocation={userLocation} />
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 pt-16">
                <EventsMap events={events} mapId="map-fullscreen" userLocation={userLocation} />
              </div>
            </motion.div>
          </motion.div>
        )}
