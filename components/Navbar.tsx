                ...
                `}
							>
								<AnimatePresence mode="wait">
													...
													<div className="p-3 sm:p-4 rounded-xl bg-gray-50">
														...
														<div className="mb-4">
															<input
																...
																style={{
																	background: `linear-gradient(to right, #006d77 0%, #006d77 ${
																		((customRadius - 5) / 195) * 100
																	}%, #e5e7eb ${
																		((customRadius - 5) / 195) * 100
																	}%, #e5e7eb 100%)`,
																}}
                                    ...
                                    ${
																			!inRange && !isPast && isCurrentMonth
																				? "hover:bg-gray-100"
																				: ""
																		}
                                    ${
																			isToday(date) && !isStart && !isEnd
