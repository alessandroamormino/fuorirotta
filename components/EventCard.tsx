	...
	return (
		<Link href={`/eventi/${event.id}`} className="group cursor-pointer">
			<div className="flex flex-col">
				{/* Image */}
				<div className="relative w-full aspect-square mb-2 sm:mb-3 overflow-hidden rounded-lg sm:rounded-xl border border-[#83c5be]/30 sm:border-2 group-hover:border-[#006d77]/50 transition-all duration-300 shadow-sm group-hover:shadow-md">
					{event.imageUrl ? (
						<img
							src={event.imageUrl}
							alt={event.title}
