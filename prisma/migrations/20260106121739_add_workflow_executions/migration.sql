...
CREATE INDEX IF NOT EXISTS "idx_events_location_city" ON "events"("location_name");

CREATE INDEX "idx_events_query_pattern" ON "events"("date_start", "category", "location_name")
