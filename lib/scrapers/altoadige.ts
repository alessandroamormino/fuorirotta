 ...
 */
const TITLE_CATEGORY_FAMILIES: Array<{ category: string; keywords: string[] }> = [
  {
  ...
  },
  {
    ...
    keywords: ['concerto', 'musica', 'festival', 'brass', 'coro', 'teatro', 'cabaret', 'band', 'magia', 'gala']
  },
  {
  ...
  },
  {
    ...
    // plurale separata.
    keywords: ['mostra', 'museo', 'visit', 'tour guidato', 'conferenza', 'seminario', 'anniversario', 'planetario']
  }
]
